...
public class StringTest {
     ...
     *               serial:顺序排列的，seriali：系列 ，serializ：序列化
     *               serializable:可序列化的，连续
...
//        s1 = "hello";
    ...
    @Test
    public void test2(){
        //通过字面量定义的方式：此时s1和s2的数据javaEE声明在方式区中的字符串常量池中
        String s1 = "javaEE";
        String s2 = "javaEE";
        ...
        System.out.println(p1.equals(p2.name));//true
    ...
    public void test3(){
        ...
        String s8 = s5.intern();//返回值的得到的s8使用的常量值中已经存在的"javaEEhadoop"
